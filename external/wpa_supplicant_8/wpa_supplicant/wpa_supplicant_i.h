...
struct wpa_params {
	...
	/**
	 * first_scan_delay_msec - Optional delay of first scan
	 *
	 * This parameter can be used to delay first scan when wpa_supplicant is
	 * started.
	 */
	int first_scan_delay_msec;
};
...
#define MAX_SCAN_ID 16
	...
	unsigned int scan_delay_in_progress:1;
