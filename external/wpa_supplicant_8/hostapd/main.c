...
#include <cutils/properties.h>  //CONN-FY-WIFI-PortingHOSAPDDebugTool
...
int main(int argc, char *argv[])
{
...
#endif /* CONFIG_DEBUG_LINUX_TRACING */
        char hostapd_dbg[PROPERTY_VALUE_MAX] = {'\0'};  //CONN-FY-WIFI-PortingSupplicantDebugTool
    ...
    //CONN-FY-WIFI-PortingHOSAPDDebugTool++
